    ...
    <section>
      <div className="header">
        ...
        <div className="btn">
          ...
          <Button to="/add-scenario" backgroundColor="#1bd27c">
            New Scenario
          </Button>
          <Button to="/add-vehicle" backgroundColor="orange">
            Add Vehicle
          </Button>
          <Button to="#" backgroundColor="skyblue" onClick={deleteAllHandler}>
            Delete All
          </Button>
                ...
                tableData.map((s, i) => (
                  <tr key={i}>
                    ...
                    <td style={{ cursor: 'pointer' }}>
                      ...
                      >
                        <AiFillPlusCircle style={{ size: '30px' }} />
                      </Link>
                    </td>
                    <td style={{ cursor: 'pointer' }}>
